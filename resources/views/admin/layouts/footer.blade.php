<footer class="footer">
    <div class="w-100 clearfix">
        <span class="text-center text-sm-left d-md-inline-block">Copyright © 2021 iCare. All Rights Reserved.</span>
        <span class="float-none float-sm-right mt-1 mt-sm-0 text-center">Developed by <a href="http://lavalite.org/" class="text-dark" target="_blank">Ainnur Husna and Nur Izzati</a></span>
    </div>
</footer>
