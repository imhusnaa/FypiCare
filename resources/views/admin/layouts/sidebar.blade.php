    ...
    <div class="app-sidebar colored">
        <div class="sidebar-header">
            <a class="header-brand" href="index.html">
                <div class="logo-img">
                   <img src="{{asset('logo/logo iCare.png')}}" class="header-brand-img" style="border-radius: 50%; width:1.5em; height:auto;"> 
                </div>
                <span class="text">iCare</span>
            </a>
            ...
            <div class="nav-container">
                <nav id="main-menu-navigation" class="navigation-main">
                    ...
                    <div class="nav-item has-sub">
                        <a href="javascript:void(0)"><i class="ik ik-layers"></i><span>Counsellors</span> <span class="badge badge-danger"></span></a>
                        <div class="submenu-content">
                            <a href="{{route('counsellor.create')}}" class="menu-item">Create</a>
                            <a href="{{route('counsellor.index')}}" class="menu-item">View</a>
                    ...
                    <div class="nav-item has-sub">
                        ...
                        <div class="submenu-content">
                            <a href="{{route('students.today')}}" class="menu-item">Students for Today</a>
                            <a href="{{route('all.students')}}" class="menu-item">All Students' Appointment</a>
                            <a href="{{route('write.report')}}" class="menu-item">Write/View Report</a>
                        </div>
                    </div>
                    @endif
                    ...
                    @if(auth()->check()&& auth()->user()->role->name === 'counsellor')
                    <div class="nav-item active">
                        <a href="{{ url('/streaming') }}"><i class="ik ik-layers"></i><span>Video Meeting</span></a>
                    ...
                    <div class="nav-item active">
                        ...
                        <i class="ik ik-layers"></i><span>Your Message</span></a>
